...
merged_df = merged_df[(merged_df['Charging Power'].notnull()) & (merged_df['Charging Power'] != 0) & (merged_df['Camera Pixel'].notnull())]
...
sorted_df.to_csv("all_samsung_data.csv", index=False)